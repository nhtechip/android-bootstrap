...
This repository contains the source code for the [nhtechip](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.tung.android.bootstrap).

Please see the [issues](https://github.com.tung.android.bootstrap/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about nhtechip? Ask away on the [com-tung-android-bootstrap discussion forum](https://groups.google.com/forum/#!forum/com-tung-android-bootstrap). 

<a href="https://play.google.com/store/apps/details?id=com.tung.android.bootstrap" alt="Download from Google Play">
...
After generating the app on [AndroidBootstrap.com](http://www.androidbootstrap.com) the folder structure of the source code for the app will change:
  ...
  - From: __com.tung.android.bootstrap__ 
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.tung.android.bootstrap__ will be moved to the new folder __com/notify/app/mobile__. 

All import statments that reference the old resources (__R.com.tung.android.bootstrap.R__) will now be renamed to the correct package. The artifact id's in the *pom.xml* (and various other places) will be replaced. The App Name will be replaced in the strings/etc. 
...
signed with a different key.  Manually uninstall nhtechip from your device and
...
You can then import the nhtechip project by doing File/Import/Gradle/Gradle Project
and the clicking the Browse button to point to the nhtechip directory.  Click
...
nhtechip is a result of a template project I've developed over the years as well as
...
nhtechip is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.tung.android.bootstrap/contributors) on this project. Your help is much appreciated.


## Contributing

Please fork this repository and contribute back using
[pull requests](https://github.com.tung.android.bootstrap/pulls).
